    ...
    <div class="container">
      <div class="row d-flex justify-content-center">
        <div class="col col-md-8 pb-5 text-center">
          <h2 class="text-amarelo">Tenha o controle <span class="text-roxo">em suas mãos</span></h2>
        </div>
      </div>
    ...
    <div class="container">
      <div class="row d-flex justify-content-center">
        <div class="col-10 col-md-6 text-center mb-5">
          <h2 class="text-roxo">Um produto novo com<br /> <span class="text-amarelo">DNA líder de mercado</span></h2>
        </div>
      </div>
    ...
    <div class="container">
      <div class="row d-flex justify-content-center">
        <div class="col-12 col-md-6 text-center mb-5">
          <h2 class="text-amarelo">Conheça nossa equipe</h2>
        </div>
      </div>
  ...
  <footer>
    <div class="container">
      <div class="row">
        ...
        <div class="col-12 col-md-6 d-flex justify-content-center align-items-center wow fadeInDown" data-wow-delay=".2s">
          ...
          <p class="text-roxo"><strong>Belo Horizonte</strong><br />
            ...
            Lourdes . Belo Horizonte . CEP: 30170-081</p>
        </div>
      </div>
      ...
      <div class="row">
        <div class="col-12">
          <hr />
          <p class="text-roxo text-center">© Copyright 2020 Partner Bank . Todos os direitos reservados</p>
        </div>
      </div>
    </div>
  </footer>
